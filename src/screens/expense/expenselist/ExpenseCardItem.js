...
const ExpenseCardItem = props => {
    ...
    if (props.expenseData.isAttachment !== '') {
                ...
                <View style={styles.itemRoot}>
                    <View style={styles.dateBox}>
                        <View style={styles.monthContainer}>
                            <Text style={styles.monthText}>{props.expenseData.expenseMonth}</Text>
                        </View>
                        <View style={styles.dateContainer}>
                            <Text style={styles.dateText}>{props.expenseData.expenseDate}</Text>
                        </View>
                    </View>
                    <View style={{ marginLeft: 8, marginRight: 5, flex: 4, alignItems: 'flex-start' }}>
                        <View style={{ alignItems: 'flex-start', justifyContent: 'center' }}>
                            <View style={{ marginTop: 5 }}>
                                <Text style={styles.titleText} numberOfLines={1} ellipsizeMode='tail' >{props.expenseData.expenseNarration}</Text>
                            </View>
                    ...
                    <View style={{ flex: 1, paddingLeft: 12, paddingRight: 12, alignItems: 'center', justifyContent: 'center' }}>
                        <View>
                            <Text style={styles.currencyStyle}>{props.expenseData.expenseAmount}</Text>
                        </View>
                        <View>
                            <Text style={styles.currencyStyle}>{props.expenseData.expenseCurrency}</Text>
                        </View>
                    </View>
                </View>
            </ExpenseCard>
